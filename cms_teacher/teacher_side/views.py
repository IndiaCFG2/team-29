...
def schedule(request):
	if request.method == 'POST':
		...
		data = {'event_date' : date, 'event_time' : time, 'event_desc' : desc, 'classroom' : classroom}
...
def view_schedules(request):
	...
	for i in databaseInstance:
		temp = i.val()
		obj = {'date' : temp['event_date'], 'time' : temp['event_time'], 'desc' : temp['event_desc'], 'classroom' : temp['classroom']}
		dic.append(obj)
